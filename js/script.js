...
str = str + '<div id="game-' + i + '-' + j + '-h" class="' + clsh + '" style="text-align:right;display:block;padding-left:0px;padding-right:10px" data-md="'+i+'" data-game="'+j+'">' + hh + '</div><div id="game-' + i + '-' + j + '-hs" class="a" style="width:30px;padding:0px;text-align:center;display:block" contenteditable>'+hhs+'</div><div id="game-' + i + '-' + j + '-d" class="a date" style="width:62px;padding:0px;text-align:center;display:block">' + ddd + '</div><div id="game-' + i + '-' + j + '-as" class="a" style="width:30px;padding:0px;text-align:center;display:block" contenteditable>'+aas+'</div><div id="game-' + i + '-' + j + '-a" class="' + clsa + '" style="text-align:left;display:block" data-md="'+i+'" data-game="'+j+'">' + aa + '</div>';
//j++;
});
